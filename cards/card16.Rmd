...
percent_performance <-round((numerator/denominator)*100, 0)
...
**Subject:** You may have an opportunity to improve PONV 03
...
Y ou may have an opportunity to improve your performance for the measure [postoperative nausea and vomiting](https://mpog.org/files/quality/measures/ponv-03_spec.pdf) (PONV 03), which is below the goal of 90% at `r percent_performance`% (`r numerator`/`r denominator`).
